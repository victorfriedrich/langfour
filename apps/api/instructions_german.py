...
INSTRUCTION_VERIFY_LANGUAGE = """From the following words, identify those that are not suitable to be added to learning flashcards. This includes mainly words that are not german, but also misspellings and:
    1. Person names
    2. Company names or website domains
    3. English words that are not german
